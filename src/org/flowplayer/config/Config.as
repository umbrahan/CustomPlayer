...
package org.flowplayer.config {
	...
	import org.flowplayer.util.MaskConfiguration;
	...
	public class Config { 
		...
		public function getMaskConfiguration():MaskConfiguration {
			if (! _configObject.mask) return new MaskConfiguration();
			return new PropertyBinder(new MaskConfiguration(), null).copyProperties(_configObject.log) as MaskConfiguration;
		}
