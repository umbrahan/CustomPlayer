...
package org.flowplayer.model {
	...
	public class Clip extends ClipEventDispatcher implements Extendable {
		...
		private var _maskc : uint = 0;
		private var _maska : Number = 1.0;
		private var _maskx : Number = 0;
		private var _masky : Number = 0;
		private var _maskw : Number = 0;
		...
		[Value]
		public function get maskc() : uint { return _maskc; }
		[Value]
		public function get maska() : Number { return _maska; }
		[Value]
		public function get maskx() : Number { return _maskx; }
		[Value]
		public function get masky() : Number { return _masky; }
		[Value]
		public function get maskw() : Number { return _maskw; }
		[Value]
		public function get maskh() : Number { return _maskh; }

		public function set maskc(val : uint) : void {  _maskc = val; }
		public function set maska(val : Number) : void { _maska = val; }
		public function set maskx(val : Number) : void { _maskx = val; }
		public function set masky(val : Number) : void { _masky = val; }
		public function set maskw(val : Number) : void { _maskw = val; }
		public function set maskh(val : Number) : void { _maskh = val; }
